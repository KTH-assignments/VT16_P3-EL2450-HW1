...
MAKECMD         = /home/li9i/MATLAB/R2014b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL              = tanks
MODULES            = tanks_acc_data.c 
MAKEFILE           = tanks.mk
MATLAB_ROOT        = /home/li9i/MATLAB/R2014b
ALT_MATLAB_ROOT    = /home/li9i/MATLAB/R2014b
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/li9i/KTH/VT16/1/EL2450\ -\ Hybrid\ and\ Embedded\ Control\ Systems/Homework/1/code/H1_src
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 3
...
$(PROGRAM) : $(OBJS) $(SHARED_LIB) $(LIBS)
	@echo "### Linking ..."
	$(CC) $(MEX_FLAGS) -MATLAB_ARCH=$(ARCH) -silent -outdir $(RELATIVE_PATH_TO_ANCHOR) $(LINK_OBJS) $(SHARED_LIB) $(LIBS) $(MATHLIBS) $(LIBSLFILEIO) $(LIBSIGSTREAM)
