...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/01.tex}}
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/02.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/04.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/06.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/08.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/1.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/2.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/3.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/4.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/5.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/6.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/7.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/8/8.tex}}
  \caption{Step response using a discrete controller (red) with sampling time
