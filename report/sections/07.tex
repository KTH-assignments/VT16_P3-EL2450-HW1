...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/7/root_locus_F_G.tex}}
...
\begin{figure}[H]\centering
	\centering
	\scalebox{1}{\input{./images/7/root_locus_F_ZOH_G.tex}}
...
\begin{minipage}{\linewidth}\centering
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]\centering
      \centering
      \scalebox{0.7}{\input{./images/7/zoh_1.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]\centering
      \centering
      \scalebox{0.7}{\input{./images/7/zoh_2.tex}}
...
\begin{minipage}{\linewidth}\centering
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]\centering
      \centering
      \scalebox{0.7}{\input{./images/7/zoh_3.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]\centering
      \centering
      \scalebox{0.7}{\input{./images/7/zoh_4.tex}}
...
\begin{minipage}{\linewidth}\centering
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]\centering
      \centering
      \scalebox{0.7}{\input{./images/7/zoh_5.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]\centering
      \centering
      \scalebox{0.7}{\input{./images/7/zoh_6.tex}}
...
\begin{minipage}{\linewidth}\centering
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]\centering
      \centering
      \scalebox{0.7}{\input{./images/7/zoh_7.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]\centering
      \centering
      \scalebox{0.7}{\input{./images/7/zoh_8.tex}}
